...
//return the number of bytes that was spurious retransed due to sack and snd_una
...
//return the number of bytes that was sacked 
...
// update block_list according to sack_block
